...
scanners (#5–#10) for something to run; on the custom-requests tool
(`add-custom-requests-tool`) for the manual-request surface; and on authentication (#13)
...
- Depends on changes #2, #4, #5–#11, and #13 being archived first (per `IMPLEMENTATION_ORDER.md`).
