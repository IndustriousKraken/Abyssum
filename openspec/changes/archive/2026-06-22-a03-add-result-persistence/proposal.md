...
(c02) owns which user can see which session. This capability stores and queries scans and
...
- Unblocks the CLI (c01), web (c03), annotations (d00), reports (d01), and AI-assist (d02),
