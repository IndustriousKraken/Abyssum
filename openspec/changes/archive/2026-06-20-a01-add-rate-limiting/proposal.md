...
spine (`bootstrap-rust-workspace`); the scanners (b00–b05) and orchestration (a02) consume it.
...
- Unblocks every scanner (b00–b05): they call this limiter so probing respects the floor.
